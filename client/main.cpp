...
void bigNumber_test()
{
    ...
    n3 = "123018668453011775513049495838496272077285356959533479219732245215172640050726"
...
void rsa_test()
{
    ...
    BigNumber encode, decode;
    encode = 65;
    decode = 2790;

    Q_ASSERT(rsa.test_key_d(key));
    Q_ASSERT(rsa.encode(encode) == "2790");
    Q_ASSERT(rsa.decode(decode) == "65");
}
